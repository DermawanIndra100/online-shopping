<!-- kalo mau keliatan cartnya hapus semua <c> elemntnya -->
		...
		<c:when test="${not empty cartLines}">
			<table id="cart" class="table table-hover table-condensed">
					...
					<tr>
							<td data-th="Product">
								<div class="row">
									<div class="col-sm-5 hidden-xs"><img src="${images}/${cartLine.product.code}.JPG" alt="${cartLine.product.name}" class="img-responsive cartImg"/></div>
									<div class="col-sm-7">
